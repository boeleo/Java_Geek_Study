...
```
DROP SCHEMA if exists ElectronicCommerceTrading_Slave; 
-- ----------------------------------------------------------------------------
-- Schema ElectronicCommerceTrading_Slave
-- ----------------------------------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ElectronicCommerceTrading_Slave` DEFAULT CHARACTER SET utf8;

-- ----------------------------------------------------------------------------
-- Customer related tables
-- ----------------------------------------------------------------------------
-- ----------------------------------------------------------------------------
-- Table ElectronicCommerceTrading_Slave.CustomerShippingAddress
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ElectronicCommerceTrading_Slave`.`CustomerShippingAddress` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `Province` VARCHAR(10) NOT NULL,
  `City` VARCHAR(10) NOT NULL,
  `District` VARCHAR(10) NOT NULL,
...
-- ----------------------------------------------------------------------------
-- Table ElectronicCommerceTrading_Slave.CustomerInfo
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ElectronicCommerceTrading_Slave`.`CustomerInfo` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `Username` VARCHAR(20) NOT NULL,
  `Password` VARCHAR(20) NOT NULL,
  `CellPhoneNo` BIGINT(20) NOT NULL,
...
-- ----------------------------------------------------------------------------
-- ----------------------------------------------------------------------------
-- Table ElectronicCommerceTrading_Slave.GoodsInfo
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ElectronicCommerceTrading_Slave`.`GoodsInfo` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(20) NOT NULL,
  `Discription` VARCHAR(20) NOT NULL,
  `Price` INT(20) NOT NULL,
...
-- ----------------------------------------------------------------------------
-- ----------------------------------------------------------------------------
-- Table ElectronicCommerceTrading_Slave.OrderInfo
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ElectronicCommerceTrading_Slave`.`OrderInfo` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `CreateDate` DATETIME(6) NOT NULL,
  `Quantity` INT(20) NOT NULL,
  `CustomerID` BIGINT(20) NOT NULL,
...
-- Insert initial data
-- ----------------------------------------------------------------------------
INSERT INTO ElectronicCommerceTrading_Slave.CustomerShippingAddress (ID, Province, City, District, Address, Contact, CellPhoneNo) VALUES (0,'Shanghai','Shanghai','Pudong','No 2290 Zuchongzhi Road','Beatrice He','1234567890');

INSERT INTO ElectronicCommerceTrading_Slave.CustomerInfo (Username, Password, CellPhoneNo, RegistrationDate, MailAddress, DefaultShippingAddressID) VALUES ('Beatrice He','xxxxxx','1234567890',Now(),'Beatrice.He@126.com',0);

INSERT INTO ElectronicCommerceTrading_Slave.GoodsInfo (ID, Name, Discription, Price, Stock, SalesVolume) VALUES (0,'Apple','A kind of fruit', 10, 100, 99);
```